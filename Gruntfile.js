module.exports = function (grunt) {
	...
	grunt.registerTask('compile', ['babel', 'concat', 'umd', 'copy:setupFiles', 'jshint', 'uglify']);
	...
	grunt.initConfig({
		...
		uglify: {
			...
			my_target: {
				...
				files: {
					'dist/textAngular.min.js': ['bower_components/rangy/rangy-core.js', 'bower_components/rangy/rangy-selectionsaverestore.js', 'src/js-compiled/*.compiled.js', 'dist/textAngular.umd.js'],
					// 'dist/textAngular-sanitize.min.js': ['src/textAngular-sanitize.js', 'dist/textAngular.umd.js'],
