	...
	grunt.initConfig({
		...
		uglify: {
			...
			my_target: {
				...
				files: {
					'dist/textAngular.min.js': ['bower_components/rangy/rangy-core.js', 'bower_components/rangy/rangy-selectionsaverestore.js', 'src/textAngular-sanitize.js', 'dist/textAngular.umd.js'],
